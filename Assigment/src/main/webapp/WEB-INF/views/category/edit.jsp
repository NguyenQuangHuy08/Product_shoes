        ...
        <div id="content">
            ...
            <div class="article">
                <frm:form
                                ...
                                <div class="boder">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input name="imageCategory" style="margin-left: 30px; width: 300px" value="${category.image}" type="file"/>
                                        </div>
                                        <br>
                                        <br>
                                        <div class="col-12">
                                            <label style="margin-left: 500px">Name</label>
                                            <frm:input path="name" cssStyle="margin-left: 30px; width: 300px" value="${category.name}"/>
                    ...
                    <br>
                        <button style="margin-left: 500px; margin-bottom: 40px" type="submit" class="btn btn-primary" onclick="if (!confirm('Bạn chắc chắn muốn edit không ?')){return false;}else {return true;}">Edit</button>
                    <br>
                    <br>
                    </frm:form>
            </div>
