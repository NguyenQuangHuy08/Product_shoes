...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <%--Todo code article--%>
            <br>
            <h3 style="text-align: center">Thêm sản phẩm Category</h3>
            <br>
            <br>
            <a href="${pageContext.request.contextPath}/category/list"><button class="btn btn-primary" style="margin-left: 30px">Back</button></a>
            <div class="article">
                <br>
                <br>
                <frm:form
                        ...
                        <div class="boder">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input style="margin-left: 30px" name="imageCategory" value="" type="file"/>
                                </div>
                                <br>
                                <br>
                                <div class="col-12">
                                    <label style="margin-left: 450px">Name</label>
                                    <frm:input style="margin-left: 30px; width: 300px" path="name" value=""/>
                                    <div class="textTitle"><frm:errors style="margin-left: 450px;color: red" class="errors" path="name" /></div>
                                </div>
                            </div>
                        </div>
                        <br>
                        <br>
                        <button type="submit" style="margin-left: 450px; margin-bottom:40px"  class="btn btn-primary" onclick="if (!confirm('Bạn chắc chắn muốn thêm không ?')){return false;}else{return true;}">Create</button>
                        <br>
                        <br>
                    </frm:form>
            </div>
