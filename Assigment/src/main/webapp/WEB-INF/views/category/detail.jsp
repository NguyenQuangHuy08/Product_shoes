...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <%--Todo code article--%>
            <br>
            <h3 style="text-align: center">Thông tin Category</h3>
            <a href="${pageContext.request.contextPath}/category/list"><button style="margin-left: 30px" class="btn btn-primary">Back</button></a>
            <br>
            <div class="article">
                <br>
                <a class="col-sm-4" href="${pageContext.request.contextPath}/category/detail/${category.id}">
                        <div class="card" style="width: 18rem; margin-left: 500px">
                                <img width="100%" style="margin-top: 7px" src="${pageContext.request.contextPath}/upload/${category.image}">
                                <div class="card-body">
