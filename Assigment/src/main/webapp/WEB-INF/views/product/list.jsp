...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <%--Todo code article--%>
            <br>
            <h3 style="text-align: center">Danh sách list Product</h3>
            <br>

            <div>
                <a class="col-sm-4"
                   href="${pageContext.request.contextPath}/product/create">
                    <button class="btn btn-primary" style="margin-left: 20px">Create</button>
                </a>            </div>
            <div class="article">
                <table class="table">
                    <thead>
                    ...
                    <c:forEach var="product" items="${products}" varStatus="i">
                        <tr>
                            ...
                            <td class="img_upload">
                                <img class="img_upload_file" width="20%" style="margin-top: 7px; height: 100px"
                                     src="${pageContext.request.contextPath}/upload/${product.image}">
                            </td>
                            <td style="text-align: center; padding-top: 40px">${product.name}</td>
                            <td style="text-align: center; padding-top: 40px">${product.price} VNĐ</td>
                            <td style="text-align: center; padding-top: 40px">${product.title}</td>
                            <td style="text-align: center; padding-top: 40px">
                                <div class="bt">
                                    ...
                                    <a class="col-sm-4"
                                       href="${pageContext.request.contextPath}/product/edit/${product.id}">
                                        <button class="btn btn-primary">Edit</button>
                                    </a>
                                    <a class="col-sm-4"
                                       href="${pageContext.request.contextPath}/product/delete/${product.id}">
                                        <button class="btn btn-primary" onclick="if (!confirm('Bạn chắc chắn muốn xóa không ?')){return false;}else {return true;}">Delete</button>
                                    </a>
