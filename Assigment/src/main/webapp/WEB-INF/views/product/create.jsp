...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <%--Todo code article--%>
            <br>
            <h3 style="text-align: center">Thêm sản phẩm Product</h3>
            <br>
            <div class="article">
                    <frm:form
                            ...
                            enctype="multipart/form-data">
                                <div class="boder">
                                    <br>
                                    <br>
                                    <div class="row" id="row_lb">
                                        <div class="col-12" >
                                            <div class="col_12_css">
                                                <label style="margin-left: 400px">Image</label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <frm:input path="name"  cssStyle="width: 400px; margin-left: 22px" value=""/>
                                            <div class="textTitle"><frm:errors cssStyle="margin-left: 400px; color: red" class="errors" path="name" /></div>
                                            <br>
                                        </div>
                                        <div class="col-12">
                                            <label style="margin-left: 400px">Price</label>
                                            <frm:input path="price" cssStyle="width: 400px; margin-left: 30px" value=""/>
                                            <br>
                                            <br>
                                        </div>
                                        <div class="col-12">
                                            <label style="margin-left: 400px">Title</label>
                                            <frm:input path="title" value="" cssStyle="width: 400px; margin-left: 31px"/>
                                            <div class="textTitle"><frm:errors cssStyle="margin-left: 400px; color: red" class="errors" path="title" /></div>
                                            <br>
                                            <br>
                                            <br>
                                        </div>
                        ...
                        <button type="submit" onclick="if (!confirm('Bạn chắc chắn muốn thêm không ?')){return false;}else{return true;}" style="margin-left: 400px" class="btn btn-primary">Create</button>
                    </frm:form>
                <br>
            </div>
